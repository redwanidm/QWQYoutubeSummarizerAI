...
const VideoSummaryResult = ({
  ...
  return (
    <div
      className={`w-full max-w-4xl mx-auto mt-4 transition-all duration-500 animate-fade-up ${
        className || ""
      }`}
    >
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 p-4 flex flex-col">
            <div className="relative aspect-video w-full overflow-hidden rounded-lg mb-4">
              ...
              />
              <div
                className={`absolute bottom-2 right-2 bg-black/70 text-white text-xs px-2 py-1 rounded-md flex items-center  font-[system-ui] antialiased`}
              >
            ...
            <a
              className="text-lg font-semibold mb-1 line-clamp-2 hover:underline"
              target="_blank"
              href={`${videoLink}`}
            >
              {videoTitle}
            ...
            <div className="mt-auto pt-4">
              <div
                className={`tooltip w-full ${mateSc?.className}`}
          ...
          <div className="w-full md:w-2/3 p-4">
            ...
            <div
              role="tablist"
              className={`tabs tabs-box  mb-4 w-full flex justify-around p-3 ${mateSc?.className} antialiased`}
            >
              <a
                role="tab"
              ...
              <a
                role="tab"
                className={`tab ${
                  activeTab === "keypoints" ? "tab-active" : ""
                }`}
              ...
              >
                <div className="card bg-base-200">
                  <div className="card-body p-4 max-h-full overflow-auto">
                    ...
                    <p
                      className={`${
                        summary.startsWith("ERROR") ? "text-error " : ""
                        ...
                        quotes.map((quote, index) => (
                          ...
                          >
                            <div className="flex items-start gap-2">
                              ...
                              <p className="text-sm italic mt-1" dir="auto">
                                &quot;{quote}&quot;
                              </p>
                            </div>
                          </li>
                ...
                <div className="card bg-base-200">
                  <div className="card-body p-4 max-h-full overflow-auto">
                    <div className="mb-2 flex flex-col sm:flex-row sm:items-center justify-between">
                      <h3 className="text-md font-medium mb-2 sm:mb-0">
                          ...
                          >
                            ...
                            <div className="collapse-title flex flex-col sm:flex-row items-start sm:items-center justify-between">
                              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full">
                                <span
                                  className={`badge badge-primary badge-sm flex items-center mr-1 mb-2 sm:mb-0 w-fit px-2 ${mateSc?.className}`}
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-3 w-3 md:mr-1"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  >
                                ...
                                <span
                                  ...
                                  className={`text-sm text-base-content/80 break-words w-full  ${mateSc?.className}`}
                                  dir="auto"
                                >
                            ...
                            <div className="collapse-content text-sm border-t border-base-300">
                              <p className="pt-3 break-words" dir="auto">
                                {section.summary}
                              </p>
                              <Link
                                href={`https://www.youtube.com/watch?v=${videoId}&t=${convertTimeToSeconds(
                                  section.startTime
                                )}`}
                                target="_blank"
